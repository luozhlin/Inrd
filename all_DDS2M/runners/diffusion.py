...
class Diffusion(object):
    ...
    def sample_sequence(self, model, config=None, logger=None, image_folder=None):
        ...
        mask = None
        mat['img_clean'] = mat['gt']
        # mat['mask_10'] = mat['mask']
        ...
        sigma_0 = mat["sigma"] / 255.0
        sigma_0 = 2*sigma_0.item()
        ...
        img_noisy = torch.from_numpy(np.float32(mat['input'])).permute(2, 0, 1).unsqueeze(0).to(self.device)
